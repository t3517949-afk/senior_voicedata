...
const SYLLABLE_COMPARISON_ROWS: SyllableComparisonRow[] = [
  {
    ...
    boldChar: '山',
    youth: {
      audioSrc: ${import.meta.env.BASE_URL}syllable-compare/young0011.wav',
      imageSrc: ${import.meta.env.BASE_URL}syllable-compare/young0011.png',
      pitchHz: '280.80Hz',
      formants: ['F1=738Hz', 'F2=1792Hz', 'F3=3332Hz', 'F4=4094Hz'],
    },
    elderly: {
      audioSrc: ${import.meta.env.BASE_URL}syllable-compare/Elderly0011.wav',
      imageSrc: ${import.meta.env.BASE_URL}syllable-compare/elderly0011.png',
      pitchHz: '273.72Hz',
  ...
  },
  {
    ...
    boldChar: '加',
    youth: {
      audioSrc: ${import.meta.env.BASE_URL}syllable-compare/young0014.wav',
      imageSrc: ${import.meta.env.BASE_URL}syllable-compare/young0014.png',
      pitchHz: '275.57Hz',
      formants: ['F1=597Hz', 'F2=1898Hz', 'F3=3134Hz', 'F4=3979Hz'],
    },
    elderly: {
      audioSrc: ${import.meta.env.BASE_URL}syllable-compare/Elderly0014.wav',
      imageSrc: ${import.meta.env.BASE_URL}syllable-compare/elderly0014.png',
      pitchHz: '236.52Hz',
  ...
  },
  {
    ...
    boldChar: '养',
    youth: {
      audioSrc: ${import.meta.env.BASE_URL}syllable-compare/young0015.wav',
      imageSrc: ${import.meta.env.BASE_URL}syllable-compare/young0015.png',
      pitchHz: '215.16Hz',
      formants: ['F1=805.78Hz', 'F2=1187.75Hz', 'F3=3203.06Hz', 'F4=3647.03Hz'],
    },
    elderly: {
      audioSrc: ${import.meta.env.BASE_URL}syllable-compare/Elderly0015.wav',
      imageSrc: ${import.meta.env.BASE_URL}syllable-compare/elderly0015.png',
      pitchHz: '132.07Hz',
  ...
  },
  {
    ...
    boldChar: '坡',
    youth: {
      audioSrc: ${import.meta.env.BASE_URL}syllable-compare/young0013.wav',
      imageSrc: ${import.meta.env.BASE_URL}syllable-compare/young0013.png',
      pitchHz: '274.19Hz',
      formants: ['F1=397Hz', 'F2=899Hz', 'F3=3120Hz', 'F4=4206Hz'],
    },
    elderly: {
      audioSrc: ${import.meta.env.BASE_URL}syllable-compare/Elderly0013.wav',
      imageSrc: ${import.meta.env.BASE_URL}syllable-compare/elderly0013.png',
      pitchHz: '217.28Hz',
  ...
  },
  {
    ...
    boldChar: '坡',
    youth: {
      audioSrc: ${import.meta.env.BASE_URL}syllable-compare/young0012.wav',
      imageSrc: ${import.meta.env.BASE_URL}syllable-compare/young0012.png',
      vot: '0.064 s',
    },
    elderly: {
      audioSrc: ${import.meta.env.BASE_URL}syllable-compare/Elderly0012.wav',
      imageSrc: ${import.meta.env.BASE_URL}syllable-compare/elderly0012.png',
      vot: '0.016 s',
    },
  },
  {
    ...
    boldChar: '不',
    youth: {
      audioSrc: ${import.meta.env.BASE_URL}syllable-compare/young0016.wav',
      imageSrc: ${import.meta.env.BASE_URL}syllable-compare/young0016.png',
      vot: '0.028 s',
    },
    elderly: {
      audioSrc: ${import.meta.env.BASE_URL}syllable-compare/Elderly0016.wav',
      imageSrc: ${import.meta.env.BASE_URL}syllable-compare/elderly0016.png',
      vot: '0.032 s',
    },
  },
];
