...
const PINNED_RESOURCES: ResearchResourceItem[] = [
  {
    ...
    type: 'file',
    title: '实验语料设计说明',
    url: '/research-resources/实验语料设计说明.pdf',
    description: '实验语料设计说明文档（PDF）',
    file_name: '实验语料设计说明.pdf',
    file_ext: '.pdf',
    size_bytes: null,
  ...
  },
  {
    ...
    type: 'file',
    title: '项目研究综述',
    url: '/research-resources/项目研究综述.pdf',
    description: '项目研究综述文档（PDF）',
    file_name: '项目研究综述.pdf',
    file_ext: '.pdf',
    size_bytes: null,
  ...
  },
  {
    ...
    title: '公众号“聆夕”二维码',
    url: '/research-resources/qrcode_for_gh_0148bf7acbb0_258.jpg',
    hint: '欢迎关注公众号“聆夕”',
    qr_image_url: '/research-resources/qrcode_for_gh_0148bf7acbb0_258.jpg',
    file_name: 'qrcode_for_gh_0148bf7acbb0_258.jpg',
    file_ext: '.jpg',
    size_bytes: null,
  ...
  },
  {
    ...
    url: '/research-resources/聆伴体验版（4月3日前有效）.png',
    hint: '欢迎使用小程序“聆伴（体验版）”',
    qr_image_url: '/research-resources/聆伴体验版（4月3日前有效）.png',
    file_name: '聆伴体验版（4月3日前有效）.png',
    file_ext: '.png',
    size_bytes: null,
    created_at: '2026-03-20T00:00:00+08:00',
  },
  {
    ...
    url: '/research-resources/老年人语音评价中的语料分级说明.pdf',
    description: '老年人语音评价中的语料分级说明文档（PDF）',
    file_name: '老年人语音评价中的语料分级说明.pdf',
    file_ext: '.pdf',
    size_bytes: null,
