...
const PINNED_RESOURCES: ResearchResourceItem[] = [
  {
    ...
    type: 'file',
    title: '实验语料设计说明',
    url: `${import.meta.env.BASE_URL}research-resources/实验语料设计说明`,
  ...
  },
  {
    ...
    type: 'file',
    title: '项目研究综述',
    url: `${import.meta.env.BASE_URL}research-resources/项目研究综述`,
  ...
  },
  {
    ...
    url: `${import.meta.env.BASE_URL}research-resources/老年人语音评价中的语料分级说`,
    description: '老年人语音评价中的语料分级说明文档（PDF）',
    file_name: '老年人语音评价中的语料分级说',
    file_ext: '.pdf',
    size_bytes: null,
